...
/*
    Scope determines how different blocks of code can be accessed.
        Three types of scope:
            -Global - everything in the main document is considered (browser)-DO NOT create unless intended
            -Block or Local
            -Function
*/
// Global scope
...
function carName() {
    ...
    if (true) {
        //Block scope
        //let will not let you console.log outside the scope
...
// Let/Const vs Var
/*
    Let is scoped to the immediate and enclosing block of code. Let is NOT hoisted.
    Var is hoisted and scoped to the immediate function block. Var is hoisted.
*/
...
/*
    ...
    First, to hoist or assign memory location to ALL VAR(iable) declarations as well as Function Declarations. During the second pass, the interpreter actually reads the initilization values and expressions that we have assigned, and executed our code. 
*/
...
// Arrow functions as derivatives of fx expressions are also NOT hoisted. Only with expressions
...
//Not a good idea to be hoisting things. 
